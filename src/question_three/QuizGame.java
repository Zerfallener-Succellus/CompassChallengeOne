...
public class QuizGame {
  ...
  public void quizGame() {
    ...
    String[][] questions = {
        ...
        { "Qual é a maior ilha do Brasil?", "A) Fernando de Noronha", "B) Ilha do Bananal", "C) Ilhabela", "D) Marajó",
            "D" },
        { "Qual é a principal produção agrícola do Brasil?", "A) Soja", "B) Café", "C) Algodão", "D) Arroz", "A" },
        { "Qual é o estado brasileiro que possui a maior população?", "A) São Paulo", "B) Minas Gerais",
            "C) Rio de Janeiro", "D) Bahia", "A" },
        { "Qual é o monumento mais conhecido do Brasil?", "A) Cristo Redentor", "B) Torre Eiffel", "C) Coliseu",
            "D) Grande Muralha da China", "A" },
        { "Em que ano o Brasil sediou a Copa do Mundo de futebol pela primeira vez?", "A) 1950", "B) 1962", "C) 1970",
            "D) 1986", "A" },
        { "Qual é o principal porto do Brasil?", "A) Porto de Santos", "B) Porto de Paranaguá", "C) Porto de Salvador",
            "D) Porto de Recife", "A" },
        { "Qual é o principal cartão postal do Rio de Janeiro?", "A) Maracanã", "B) Pão de Açúcar", "C) Corcovado",
            "D) Copacabana", "C" }
    };
